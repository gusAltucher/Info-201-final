...
The analysis of the data shows that there is no clear pattern linking household income to the crime rate. Our findings indicate no significant correlation between the median income and the rate of crime.
