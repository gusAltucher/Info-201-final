...
In summary, this project explore the relationship between median income and crime rates in various areas of Seattle. While the initial hypothesis was for a negative correlation between median income and crime rates, the analysis of Seattle Police Department dataset to the Seattle Median Household Income dataset shows that while there were certain weak positive correlations between income and specific property crimes, it is not a clear pattern linking household income to the crime rate. Our findings indicate no significant correlation between the median income and the rate of crime. This analysis of the data shows the limitations of relying solely on income as a determinant of crime and emphasizes the complexity of factors that influence crime rates, not just income.
